...
@SpringBootApplication(scanBasePackages={"com.cdha.wechatsub.wxtools","com.cdha.rlpiss.wx.wxservice.wxservice"})
@MapperScan("com.cdha.rlpiss.wx.wxservice.wxservice.dao")
