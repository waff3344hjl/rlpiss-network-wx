...
public class MyBase64Utils {
    private static MyBase64Utils utils = null;
    public MyBase64Utils() {
    }
    /**
     * 机能概要:单利 ，懒汉模式
     * @return
     */
    public static MyBase64Utils getInstance(){
        if(utils == null){
            synchronized (MyBase64Utils.class) {
                if(utils == null ){
                    utils = new MyBase64Utils();
                }
            }
        }
        return utils;
